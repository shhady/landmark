  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { text: 'ביצוע פרויקטי תשתיות/מבנים', href: '/services#engineering' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6 flex flex-col items-center text-center">
            ...
            <div className="flex gap-6 pt-2 justify-center">
              ...
              <a href="https://wa.me/972546220167" target="_blank" rel="noopener noreferrer" className="hover:text-green-400 transition-colors transform hover:scale-110">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.instagram.com/landmap.ltd/" target="_blank" className="hover:text-purple-500 transition-colors transform hover:scale-110">
                
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 2.163c3.204 0 3.584.012 4.85.07 1.366.062 2.633.332 3.608 1.308.975.976 1.246 2.244 1.308 3.608.058 1.268.069 1.648.069 4.851s-.012 3.584-.07 4.85c-.062 1.366-.332 2.633-1.308 3.608-.976.975-2.244 1.246-3.608 1.308-1.268.058-1.648.069-4.851.069s-3.584-.012-4.85-.07c-1.366-.062-2.633-.332-3.608-1.308-.975-.976-1.246-2.244-1.308-3.608C2.175 15.696 2.163 15.316 2.163 12s.012-3.584.07-4.85c.062-1.366.332-2.633 1.308-3.608.976-.975 2.244-1.246 3.608-1.308C8.417 2.175 8.797 2.163 12 2.163zm0-2.163C8.741 0 8.332.013 7.052.071c-1.563.07-2.946.637-4.019 1.71C1.012 3.154.443 4.537.072 6.1.013 7.38 0 7.79 0 12c0 4.21.013 4.62.071 5.9.07 1.563.637 2.946 1.71 4.019 1.073 1.073 2.456 1.64 4.019 1.71 1.28.058 1.69.071 5.9.071s4.62-.013 5.9-.071c1.563-.07 2.946-.637 4.019-1.71 1.073-1.073 1.64-2.456 1.71-4.019.058-1.28.071-1.69.071-5.9s-.013-4.62-.071-5.9c-.07-1.563-.637-2.946-1.71-4.019-1.073-1.073-2.456-1.64-4.019-1.71C15.267.013 14.859 0 12 0z"/>
                  <path d="M12 5.838a6.162 6.162 0 1 0 0 12.324A6.162 6.162 0 0 0 12 5.838zm0 10.162a3.999 3.999 0 1 1 .001-7.999A3.999 3.999 0 0 1 12 16z"/>
