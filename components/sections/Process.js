...
export default function Process() {
  const steps = [
    { 
      ...
      desc: "הבנת צרכי הפרויקט (תצ״ר, היתר, מדידה) ובדיקת היתכנות מקצועית.",
      icon: "💬"
    },
    { 
      title: "2. מדידה בשטח", 
      desc: "צוות מודדים מגיע לשטח עם ציוד GPS ורחפנים לביצוע מדידה מדויקת.",
      icon: "🛰️"
    },
    { 
      title: "3. עיבוד במשרד", 
      desc: "עיבוד הנתונים, הפקת מפות ושרטוט תוכניות לפי דרישות הרשויות.",
      icon: "💻"
    },
    { 
      title: "4. בקרת איכות", 
      desc: "בדיקה קפדנית של מודד מוסמך וחתימה על התוכניות.",
      icon: "✅"
    },
    { 
      title: "5. מסירת תוצרים", 
      desc: "קבלת תיק מדידה מושלם (דיגיטלי ומודפס) להגשה לוועדות.",
      icon: "📦"
    },
  ]
