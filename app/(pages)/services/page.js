...
מדידות טופוגרפיות ומדידות מצב קיים המשמשות בסיס להכנת תכניות סטטוטוריות, לרבות תב״ע, בהתאם לנוהל מבא״ת – המפרט הלאומי האחיד לתכנון, כולל קומפילציה של תכניות מאושרות, הכנת תשריטים למצב נכנס ומצב יוצא, חישובי שטחים וליווי שמאי לצורך הכנת טבלאות הקצאה ואיזון`,
  ...
  'תוכניות לצרכי רישום - תצר': {
    description: "הכנת תכנית לצרכי רישום לחלוקה, איחוד ורישום זכויות במקרקעין, בהתאם לתוכניות מאושרות ולדרישות המרכז למיפוי ישראל והטאבו.",
    examples: [
      {
        name: "דוגמה 1",
        files: [
  ...
  'מפות עדות (As-Made)': {
    description: 'מדידת המצב הסופי/ביניים לאחר הביצוע והפקת תוכניות עדות לקבלן ולמזמין.',
    examples: [
...
const allServices = {
  'registration': {
    ...
    services: [
      ...
      { 
        title: 'תרשים עזר – חישוב גבולות אנליטיים', 
  ...
  'engineering': {
    title: 'ביצוע פרויקטי תשתיות/מבנים וליווי הנדסי',
    ...
    services: [
      ...
      { 
        ...
        desc: 'מדידת המצב הסופי/ביניים לאחר הביצוע והפקת תוכניות עדות לקבלן ולמזמין.',
        icon: <FileCheck className="w-6 h-6" /> 
      }
    ]
  },
